...
Stable Logistic Regression with consistent preprocessing
"""
...
class FakeNewsDetector:
    """
    Stable Fake News Detection using Logistic Regression
    - Consistent preprocessing pipeline
    - Fixed random state for reproducibility
    - One-time training with model persistence
    """
    
    def __init__(self, random_state=42, threshold=0.55):
        """
        Initialize the detector with consistent parameters
    ...
    def load_data(self, csv_file='fake_news_dataset.csv'):
        ...
        try:
            ...
            print(f"⚠️  Dataset file {csv_file} not found. Creating sample data...")
    ...
    def train_model(self, X, y):
        ...
        # Initialize Logistic Regression with consistent parameters
...
# Global detector instance for stable predictions
